...
# PS C:\Users\Abram\Downloads\Tema 2\Tema_3> & C:/Users/Abram/AppData/Local/Microsoft/WindowsApps/python3.13.exe "c:/Users/Abram/Downloads/Tema 2/Tema_3/Jacobi/ejemplo_facil_4(si_converje).py"
# Calculando la solución con el método de Jacobi...

# [Éxito] La matriz fue reordenada y es diagonalmente dominante.

# [*] El método de Jacobi convergió en la iteración 23.

# La solución del sistema es:
# Variable x1 = 1.000000
# Variable x2 = 1.000000
# Variable x3 = 1.000000
# ------------------------------
# Tiempo de ejecución: 0.00042180 segundos

...
# [Advertencia Matemática]
# La matriz fue reordenada, pero NO cumple con la regla de la Diagonal Dominante.
# En un sistema tan grande, el método iterativo casi seguramente va a fallar y divergir al infinito.

# ------------------------------
# Error detectado: ¡Explosión Matemática! Los números se fueron al infinito en la iteración 6.
# Tiempo de ejecución (hasta el colapso): 0.74565980 segundos